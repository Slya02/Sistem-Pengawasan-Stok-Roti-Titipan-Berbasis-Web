      ...
      class="animate-fade-in w-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text" name="name" class="w-full px-4 py-2 border-2 border-yellow-400 rounded-lg bg-[#fffcee]" required>
            </div>

            <div>
                <label class="block text-gray-700 font-semibold mb-2">No HP / WhatsApp</label>
                <input type="number" name="phone" class="w-full px-4 py-2 border-2 border-yellow-400 rounded-lg bg-[#fffcee]" required>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text" name="owner_name" class="w-full px-4 py-2 border-2 border-yellow-400 rounded-lg bg-[#fffcee]" required>
            </div>
            <div>
                <label class="block text-gray-700 font-semibold mb-2">Alamat Lengkap</label>
                <input type="text" name="address" id="address" class="w-full px-4 py-2 border-2 border-yellow-400 rounded-lg bg-[#fffcee]" required>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="date" name="join_date" class="w-full px-4 py-2 border-2 border-yellow-400 rounded-lg bg-[#fffcee]" required>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-wrap md:flex-nowrap items-center gap-2">
                    <button type="button" id="btnMap"
                        class="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold py-2 px-4 rounded-lg shadow-sm transition w-full md:w-auto">
                        <i class="fa-solid fa-location-dot mr-1"></i> Pilih dari Peta
                    </button>
                    <input type="text" name="latitude" id="latitude" placeholder="Lat"
                        class="w-full md:w-24 px-3 py-2 border-2 border-yellow-300 rounded-lg text-sm bg-[#fffcee]" readonly>
        ...
        <div class="flex gap-4">
            <button type="submit" class="flex-1 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-2 px-4 rounded-lg shadow-md">
                <i class="fa-solid fa-save mr-1"></i> Simpan
            </button>
            <button type="reset" class="border-2 border-yellow-400 text-yellow-600 hover:bg-yellow-50 font-bold py-2 px-6 rounded-lg">
...
<div id="mapModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-[9999]">
  <div class="bg-white rounded-xl p-4 shadow-xl w-11/12 md:w-2/3 lg:w-1/2 relative animate-fade-in-up">
    ...
    <h2 class="text-lg font-bold mb-3 text-yellow-600"><i class="fa-solid fa-map-location-dot"></i> Pilih Lokasi Toko</h2>
    <div id="map" style="height: 400px;" class="rounded-lg border border-yellow-300"></div>
    <div class="flex justify-end mt-4">
      <button id="saveMap" class="bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-4 py-2 rounded-lg shadow-sm">
        Simpan Lokasi
      </button>
    </div>
  </div>
